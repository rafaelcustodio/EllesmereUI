...
local function BuildPrivateAurasPage(pageName, parent, yOffset)
    ...
    row, h = W:DualRow(parent, y,
        ...
        { type="toggle", text="Show Countdown Numbers",
          tooltip="Show the numeric countdown on each icon.",
          disabled=function() return Disabled() or Cfg("showCountdown") == false end,
          disabledTooltip="Enable Show Cooldown Swipe to adjust this.",
    ...
    row, h = W:DualRow(parent, y,
        { type="slider", text="Timer Offset X",
          tooltip="Horizontal offset of the cooldown/countdown relative to the icon center.",
          disabled=function() return Disabled() or Cfg("showCountdown") == false end,
          disabledTooltip="Enable Show Cooldown Swipe to adjust this.",
        ...
        { type="slider", text="Timer Offset Y",
          tooltip="Vertical offset of the cooldown/countdown relative to the icon center.",
          disabled=function() return Disabled() or Cfg("showCountdown") == false end,
          disabledTooltip="Enable Show Cooldown Swipe to adjust this.",
          min=-150, max=150, step=1, isPercent=false,
